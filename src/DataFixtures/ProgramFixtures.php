...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    const PROGRAMS = [
            ...
            [
                ...
                'category' => 'category_Action',
                'reference' => 'program_Peaky Blinders',
            ],
            [
                'title' => "Frontier",
            ...
            [
                ...
                'reference' => "program_Perdus dans l'espace",
            ],
            [
                'title' => "Vikings",
            ...
            [
                ...
                'reference' => 'program_Demon Slayer',
            ],
            [
                ...
                'category' => 'category_Animation',
                'reference' => 'program_The Seven Deadly Sins',
            ],
            [
                ...
                'category' => 'category_Animation',
                'reference' => "program_L'Attaque des Titans",
            ],
            [
                'title' => "Jojo's",
            ...
            [
                ...
                'category' => 'category_Fantastique',
                'reference' => 'program_Black Mirror',
            ],
            [
                'title' => "Sweet Tooth",
            ...
            [
                ...
                'category' => 'category_Fantastique',
                'reference' => 'program_Shadow and Bone',
            ],
            [
                ...
                'reference' => 'program_Stranger Things',
            ],
            [
                'title' => 'Walking Dead',
            ...
            [
                ...
                'category' => 'category_Horreur',
                'reference' => 'program_The Haunting of Hill House',
            ],
            [
            ...
            [
                ...
                'category' => 'category_Horreur',
                'reference' => 'program_The Originals',
            ],
        ];
    public function load(ObjectManager $manager)
    {
        foreach (self::PROGRAMS as $programGender) {
            ...
            $this->addReference($programGender['reference'], $program);
